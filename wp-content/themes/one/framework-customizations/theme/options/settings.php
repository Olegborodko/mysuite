...
array(
'type' => 'box',
'title' => __('Additional settings', 'fw'),
'attr' => array('data-foo' => 'bar'),
'options' => array(

'set_google_key' => array(
'type'  => 'text',
'value' => '',
'label' => __('GOOGLE KEY for map', '{domain}')
),

'set_site_donor' => array(
'type'  => 'text',
'value' => 'https://www.rentcafe.com',
'label' => __('site donor', '{domain}')
),

'set_property_page' => array(
'type'  => 'text',
'value' => get_site_url().'/property',
'label' => __('url to property page', '{domain}')
),
